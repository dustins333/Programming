...
/**
 * One-shot read of a saved draft, outside the hook.
 *
 * The hook above owns the live form; this is for surfaces that only need to
 * know whether a member has *started* something and stopped — the check-in
 * nudge and My Week's pill — without mounting the form itself. Returns the
 * saved values map, or null when there's no usable draft.
 */
