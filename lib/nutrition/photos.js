...
// A photo-required week's requirement is satisfied by any complete
// front/side/back set uploaded within this many days of today — not just
// ones uploaded during the current check-in cycle — so uploading via the
// Photos tab first (independent of the Check-In flow) still counts.
export const PHOTO_RECENCY_DAYS = 5;
