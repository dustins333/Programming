...
// deriveCheckinStatus only ever returns pending/ready/completed, so there's
// no catch-all "on track" bucket anymore), and every not-yet-approved client
// falls into exactly one of NEW_CLIENT_STATUSES. needsTarget/paused are real
...
export const ACTIVE_CLIENT_STATUSES = ["checkinPending", "readyForCheckin", "checkinCompleted"];
