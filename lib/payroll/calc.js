...
const CATEGORY_LABELERS = {
  group: (e) => `${e.group_sessions} session${e.group_sessions === 1 ? "" : "s"}`,
  strategy: (e) => `${e.strategy_sessions} session${e.strategy_sessions === 1 ? "" : "s"}`,
  programs: (e) => `${e.programs_written} program${e.programs_written === 1 ? "" : "s"}`,
  admin: (e) => `${e.admin_hours} hr${e.admin_hours === 1 ? "" : "s"}`,
  welcome: (e) => `${e.welcome_sessions} session${e.welcome_sessions === 1 ? "" : "s"}`,
  ops: (e) => `${e.ops_hours} hr${e.ops_hours === 1 ? "" : "s"}`,
  spc: (e) => `${e.spc_attendees ?? "?"} attendee${e.spc_attendees === 1 ? "" : "s"}`,
  other: (e) => `${e.other_type} ×${e.other_qty ?? 1}`,
...
// every date and quantity that added up to this total."
