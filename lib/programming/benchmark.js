...
export const LIFTS = {
  ...
  push: {
    ...
    dim: "#8c5a2a",
    rgb: "255,159,69",
    hint: "Pick your variation, then place your bell.",
...
export function isWinTone(tone) {
  return tone === "up" || tone === "grad" || tone === "first";
}

// The line under the number on the celebration. A variation move gets nothing:
// the pill already says the whole thing, and a second sentence under it reads
// as padding.
export function celebrationCopy(tone) {
  if (tone === "grad") return "";
  if (tone === "up") return "That is the training showing up.";
