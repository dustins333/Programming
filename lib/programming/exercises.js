...
export async function createExercise({ name, type = "lift", muscleGroups, movementPatterns, parentExerciseId, defaultSets, defaultReps, repUnit, tracksWeight, cues, videoUrl, createdBy }) {
