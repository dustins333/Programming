...
// Mirrors the CHECK constraints on exercises.movement_pattern and
// exercise_parents.movement_pattern (migration 0122). Keep all three in
// step. Ordered lower body, core, then upper -- the order here is the
// order the form's picker and the builder's movement-balance tally use.
