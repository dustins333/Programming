...
// in Protest Strike with the unit in Montserrat beside it; the whole tile
// is dashed while nothing's logged (house rule 1) and solid once it is.
  ...
  return (
    <View
      ...
      style={{
        ...
        paddingVertical: 12,
        backgroundColor: empty ? "transparent" : "#fff",
        borderWidth: empty ? 1.5 : 1,
        borderStyle: empty ? "dashed" : "solid",
        borderColor: empty ? DASHED_EMPTY : CARD_BORDER,
      }}
    >
      <Text
