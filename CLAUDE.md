...
**Status**: Phases 1-3 built and verified (Foundation, Workout Builder, Group Programming + Client Portal). Nutrition module and SPC are not started. See build-plan.md's "Build order — status" section for the current checklist.
