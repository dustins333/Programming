...
6. ⏳ **Coach push notifications**: plumbing exists (Phase 1), not wired to any real trigger yet — SPC's alert logic (Phase 5) exists but is dashboard-load-triggered, not a real background job/push trigger.
