...
4. ⏳ **Nutrition — core loop module**: not started.
5. ⏳ **Programming — SPC**: not started.
6. ⏳ **Coach push notifications**: plumbing exists (Phase 1), not wired to any real trigger yet since SPC alerts (Phase 5) don't exist.
